...
#define AGING_FACTOR_MIN			80
#define AGING_FACTOR_DIFF			1
...
struct usb_vol_temp usb_table[166] = {
	{-40000, 1799},
	{-39000, 1796},
	{-38000, 1793},
	{-37000, 1790},
...
#define usb_tab_len 166
#define otp_threshold 70
#define recover_threshold 60
...
int g_Q_MAX[MAX_TABLE][TOTAL_BATTERY_NUMBER] = {
	/*bat1,   bat2,   bat3,    bat4*/
	{ 4446, 4446, 2490, 1965},/*T0*/
	{ 4523, 4523, 2468, 1984},/*T1*/
	{ 4508, 4508, 2310, 1946},/*T2*/
	{ 4192, 4192, 1858, 1873},/*T3*/
	{ 3516, 3516, 1843, 1851},/*T4*/
