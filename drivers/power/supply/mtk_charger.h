...
#define PD_CHARGER_INPUT_CURRENT		2000000
...
#define BAT_OVER_TEMP 55
#define BAT_LOW_TEMP  0

/* charging abnormal status */
#define CHG_DEFAULT_STATUS	0
#define CHG_OC_STATUS		1
#define CHG_VBUS_OV_STATUS	5
#define CHG_BAT_LT_STATUS	7
#define CHG_BAT_OT_STATUS	8
#define CHG_TYPEC_WD_STATUS	9
#define CHG_ST_TMO_STATUS	10
#define CHG_VBUS_LV_STATUS	11
#define CHG_BAT_OV_STATUS	12
#define CHG_USB_OT_STATUS	13
#define CHG_DEVICE_HOT_STATUS	8
...
#define JEITA_TEMP_T1_TO_T2_CV	4250000
#define JEITA_TEMP_T0_TO_T1_CV	4250000
#define JEITA_TEMP_BELOW_T0_CV	4250000
#define TEMP_T4_THRES  45
#define TEMP_T4_THRES_MINUS_X_DEGREE 45
#define TEMP_T3_THRES  35
#define TEMP_T3_THRES_MINUS_X_DEGREE 35
...
#define LCD_QUIET_TEMP_T0 41
#define LCD_OFF_QUIET_TEMP_T0 42
#define LCD_QUIET_TEMP_T1 44
#define LCD_QUIET_TEMP_T2 46
#define LCD_QUIET_TEMP_T3 48
#define LCD_QUIET_TEMP_T4 50
#define LCD_QUIET_TEMP_T5 52
...
enum sw_quiet_state_enum {
	QUIET_TEMP_BELOW_T0 = 0,
	QUIET_TEMP_T0_TO_T1,
	QUIET_TEMP_T1_TO_T2,
	QUIET_TEMP_T2_TO_T3,
	QUIET_TEMP_T3_TO_T4,
...
struct mtk_charger {
	...
	signed int charging_enable;
	signed int usb_suspend;
	signed int schedule_chg;
	bool fv_reduction;
	signed int full_charge_setting;
	bool charge_setting_flag;
	bool otg_switch;

	unsigned int qns_cv;
	unsigned int qns_charging_current;
