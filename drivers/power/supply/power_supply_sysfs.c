...
static const char * const POWER_SUPPLY_HEALTH_TEXT[] = {
	...
	[POWER_SUPPLY_HEALTH_CHG_OVERTIME]          = "Chg overtime",
	[POWER_SUPPLY_HEALTH_USB_CONNECT_ERROR]     = "Usb connect err",
	[POWER_SUPPLY_HEALTH_BATTERY_OVERVOLTAGE]   = "Battery over voltage",
	[POWER_SUPPLY_HEALTH_UNDERVOLTAGE]          = "Under voltage",
	[POWER_SUPPLY_HEALTH_DEVICE_HOT]            = "Device hot",
	[POWER_SUPPLY_HEALTH_USB_OVERTEMPERATURE]   = "Usb over temperature",
};
