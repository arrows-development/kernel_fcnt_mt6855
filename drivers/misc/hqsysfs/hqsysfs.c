...
struct pcba {
	...
	{YAMATO_PCBA_EVB_SKU_EVB_1_5, "EVB_sku1/5"},
	{YAMATO_PCBA_EVB_SKU_EVB_2_6, "EVB_sku2/6"},
	{YAMATO_PCBA_EVB_SKU_EVT_1_5, "EVB_sku1/5"},
	{YAMATO_PCBA_EVB_SKU_EVT_2_6, "EVB_sku2/6"},
	{YAMATO_PCBA_EVB_SKU_DVT_1_5, "EVB_sku1/5"},
	{YAMATO_PCBA_EVB_SKU_DVT_2_6, "EVB_sku2/6"},
	{YAMATO_PCBA_EVB_SKU_PVT_1_5, "EVB_sku1/5"},
	{YAMATO_PCBA_EVB_SKU_PVT_2_6, "EVB_sku2/6"},

	{YAMATO_PCBA_EVT_SKU_EVB_1_5, "EVT_sku1/5"},
	{YAMATO_PCBA_EVT_SKU_EVB_2_6, "EVT_sku2/6"},
	{YAMATO_PCBA_EVT_SKU_EVT_1_5, "EVT_sku1/5"},
	{YAMATO_PCBA_EVT_SKU_EVT_2_6, "EVT_sku2/6"},
	{YAMATO_PCBA_EVT_SKU_DVT_1_5, "EVT_sku1/5"},
	{YAMATO_PCBA_EVT_SKU_DVT_2_6, "EVT_sku2/6"},
	{YAMATO_PCBA_EVT_SKU_PVT_1_5, "EVT_sku1/5"},
	{YAMATO_PCBA_EVT_SKU_PVT_2_6, "EVT_sku2/6"},
	
	{YAMATO_PCBA_DVT1_SKU_EVB_1_5, "DVT1_sku1/5"},
	{YAMATO_PCBA_DVT1_SKU_EVB_2_6, "DVT1_sku2/6"},
	{YAMATO_PCBA_DVT1_SKU_EVT_1_5, "DVT1_sku1/5"},
	{YAMATO_PCBA_DVT1_SKU_EVT_2_6, "DVT1_sku2/6"},
	{YAMATO_PCBA_DVT1_SKU_DVT_1_5, "DVT1_sku1/5"},
	{YAMATO_PCBA_DVT1_SKU_DVT_2_6, "DVT1_sku2/6"},
	{YAMATO_PCBA_DVT1_SKU_PVT_1_5, "DVT1_sku1/5"},
	{YAMATO_PCBA_DVT1_SKU_PVT_2_6, "DVT1_sku2/6"},
	
	{YAMATO_PCBA_DVT2_SKU_EVB_1_5, "DVT2_sku1/5"},
	{YAMATO_PCBA_DVT2_SKU_EVB_2_6, "DVT2_sku2/6"},
	{YAMATO_PCBA_DVT2_SKU_EVT_1_5, "DVT2_sku1/5"},
	{YAMATO_PCBA_DVT2_SKU_EVT_2_6, "DVT2_sku2/6"},
	{YAMATO_PCBA_DVT2_SKU_DVT_1_5, "DVT2_sku1/5"},
	{YAMATO_PCBA_DVT2_SKU_DVT_2_6, "DVT2_sku2/6"},
	{YAMATO_PCBA_DVT2_SKU_PVT_1_5, "DVT2_sku1/5"},
	{YAMATO_PCBA_DVT2_SKU_PVT_2_6, "DVT2_sku2/6"},

	{YAMATO_PCBA_PVT_SKU_EVB_1_5, "PVT_sku1/5"},
	{YAMATO_PCBA_PVT_SKU_EVB_2_6, "PVT_sku2/6"},
	{YAMATO_PCBA_PVT_SKU_EVT_1_5, "PVT_sku1/5"},
	{YAMATO_PCBA_PVT_SKU_EVT_2_6, "PVT_sku2/6"},
	{YAMATO_PCBA_PVT_SKU_DVT_1_5, "PVT_sku1/5"},
	{YAMATO_PCBA_PVT_SKU_DVT_2_6, "PVT_sku2/6"},
	{YAMATO_PCBA_PVT_SKU_PVT_1_5, "PVT_sku1/5"},
	{YAMATO_PCBA_PVT_SKU_PVT_2_6, "PVT_sku2/6"},
	
	{YAMATO_PCBA_MP_SKU_EVB_1_5, "MP_sku1/5"},
	{YAMATO_PCBA_MP_SKU_EVB_2_6, "MP_sku2/6"},
	{YAMATO_PCBA_MP_SKU_EVT_1_5, "MP_sku1/5"},
	{YAMATO_PCBA_MP_SKU_EVT_2_6, "MP_sku2/6"},
	{YAMATO_PCBA_MP_SKU_DVT_1_5, "MP_sku1/5"},
	{YAMATO_PCBA_MP_SKU_DVT_2_6, "MP_sku2/6"},
	{YAMATO_PCBA_MP_SKU_PVT_1_5, "MP_sku1/5"},
	{YAMATO_PCBA_MP_SKU_PVT_2_6, "MP_sku2/6"},
};
...
static HW_INFO(HWID_MAIN_CAM, main0_cam);  //main0
static HW_INFO(HWID_MAIN_CAM_1, main1_cam);  //main1
...
static HW_INFO(HWID_SD_SLOT, sd_slot);
...
static ssize_t huaqin_show(struct kobject *kobj, struct attribute *a, char *buf)
{
	...
	if (HWID_VER == hw->hw_id) {
		...
		for (i = 0; i < sizeof(pcba_map)/sizeof(struct pcba); i++) {
			if ((msg->huaqin_pcba_config) == pcba_map[i].pcba_info) {
				count = sprintf(buf, "%s\n", pcba_map[i].pcba_info_name);
				return count;
			}
		}
		count = sprintf(buf, "%s\n", "YAMATO_PCBA_UNKNOW");
	}else if (HWID_SD_SLOT == hw->hw_id) {
		gpio_value = -1;
...
static const struct proc_ops sdc_detect_proc_fops = {
	.proc_open = sdc_detect_proc_open,
	.proc_read = seq_read,
};
...
{
	/* create sysfs entry at /sys/class/yamato/interface/hw_info */
	create_sysfs();
