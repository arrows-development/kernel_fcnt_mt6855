...
#define DEVICE_VERSION_S5K4H7_SUNNY    "s5k4h7_sunny"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K4H7_SUNNY_FRONT_SENSOR_ID,	/*S5K4H7_SUNNY_FRONT_SENSOR_ID = 0x487A */
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{3264, 2448, 672, 648, 1920, 1080, 1920, 1080,  0000, 0000, 1920, 1080,  0, 0, 1920, 1080},	//hight speed video
	{3264, 2448, 672, 648, 1920, 1080, 1920, 1080,  0000, 0000, 1920, 1080,  0, 0, 1920, 1080} // slim video
};
...
static kal_uint16 s5k4h7_sunny_init_setting[] = {
	0x0100,0x00,
	0x0000,0x12,
	0x0000,0x48,
	0x0A02,0x15,
...
//030f->0XAF 700M
//step = 4
//030f->0XC8 800M 0x030F,0xC8,
static kal_uint16 s5k4h7_sunny_preview_setting[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
static kal_uint16 s5k4h7_sunny_cap_setting[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
static kal_uint16 s5k4h7_sunny_cap1_setting[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
static kal_uint16 s5k4h7_sunny_normal_video_setting[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
static kal_uint16 s5k4h7_sunny_hs_video_setting[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
static kal_uint16 s5k4h7_sunny_slim_video_setting[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
{
	table_write_cmos_sensor(s5k4h7_sunny_init_setting,
		sizeof(s5k4h7_sunny_init_setting) / sizeof(kal_uint16));
}				/*  s5k4h7_sunnyMIPI_Sensor_Init  */


static void preview_setting(void)
{
	table_write_cmos_sensor(s5k4h7_sunny_preview_setting,
		sizeof(s5k4h7_sunny_preview_setting) / sizeof(kal_uint16));
}				/*  s5k4h7_sunnyMIPI_Capture_Setting  */

static void capture_setting(kal_uint16 currefps)
{
	if (currefps == 150) {
		table_write_cmos_sensor(s5k4h7_sunny_cap1_setting,
			sizeof(s5k4h7_sunny_cap1_setting) / sizeof(kal_uint16));
	} else {
		table_write_cmos_sensor(s5k4h7_sunny_cap_setting,
			sizeof(s5k4h7_sunny_cap_setting) / sizeof(kal_uint16));
	}
}
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(s5k4h7_sunny_normal_video_setting,
		sizeof(s5k4h7_sunny_normal_video_setting) / sizeof(kal_uint16));
}

static void hs_video_setting(void)
{
	LOG_INF("EVGA 120fps");
	table_write_cmos_sensor(s5k4h7_sunny_hs_video_setting,
		sizeof(s5k4h7_sunny_hs_video_setting) / sizeof(kal_uint16));
}

static void slim_video_setting(void)
{
	LOG_INF("E");
	table_write_cmos_sensor(s5k4h7_sunny_slim_video_setting,
		sizeof(s5k4h7_sunny_slim_video_setting) / sizeof(kal_uint16));
}
	...
	do {
		*sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001))-1;
		if (*sensor_id == imgsensor_info.sensor_id) {
			LOG_INF("i2c write id: 0x%x, read sensor id: 0x%x success\n", imgsensor.i2c_write_id, *sensor_id);
#ifdef VENDOR_EDIT
			imgsensor_info.module_id = s5k4h7_sunny_get_module_id();
			if (imgsensor_info.module_id == 0x55) {
				LOG_INF("sunny read_module_id sucess: 0x%x\n", imgsensor_info.module_id);
				*sensor_id = S5K4H7_SUNNY_FRONT_SENSOR_ID;
				otp_flag = s5k4h7_sunny_otp_read();
				if (otp_flag)
					LOG_INF("Read otp succeed\n");
				else
					LOG_INF("Read otp failed\n");
				return ERROR_NONE;
			} else {
				LOG_INF("read_module_id failed: %x\n",
...
#ifdef VENDOR_EDIT
	/*zhengjiang.zhu@Camera.Drv, 2017/10/18 add for otp */
	otp_flag = s5k4h7_sunny_otp_update();
	if (otp_flag)
...
UINT32 S5K4H7_SUNNY_FRONT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*      s5k4h7_sunny_MIPI_RAW_SensorInit      */
