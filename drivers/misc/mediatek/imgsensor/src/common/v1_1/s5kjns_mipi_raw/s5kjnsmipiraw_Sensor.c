...
#include "s5kjnsmipiraw_Sensor.h"
#include "s5kjns_sensor_setting.h"
...
static void sensor_init(void)
{
    ...
    s5kjns_multi_write_cmos_sensor(
		addr_data_pair_init_s5kjnsqtech,
		sizeof(addr_data_pair_init_s5kjnsqtech) / sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	...
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_preview_s5kjnsqtech,
		sizeof(addr_data_pair_preview_s5kjnsqtech) / sizeof(kal_uint16));
}
...
static void capture_setting(kal_uint16 currefps)
{
	LOG_INF("start\n");
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_capture_s5kjnsqtech,
		sizeof(addr_data_pair_capture_s5kjnsqtech) / sizeof(kal_uint16));
}
...
static void normal_video_setting(kal_uint16 currefps)  // 30fps
{
	...
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_normal_video_s5kjnsqtech,
		sizeof(addr_data_pair_normal_video_s5kjnsqtech) / sizeof(kal_uint16));
}
...
static void hs_video_setting(void) /// 120fps
{
	...
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_hs_video_s5kjnsqtech,
		sizeof(addr_data_pair_hs_video_s5kjnsqtech) / sizeof(kal_uint16));
}
...
static void slim_video_setting(void) //60fps
{
	LOG_INF("E\n");
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_slim_video_s5kjnsqtech,
		sizeof(addr_data_pair_slim_video_s5kjnsqtech) / sizeof(kal_uint16));
}
...
static void custom1_setting(void)
{
	LOG_INF("E\n");
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_custom1_s5kjnsqtech,
		sizeof(addr_data_pair_custom1_s5kjnsqtech) / sizeof(kal_uint16));
}

static kal_uint32 return_sensor_id(void)
{
	// return ((read_cmos_sensor_byte(0x0001) << 8) | read_cmos_sensor_byte(0x0000) + 1);
		...
		do {
			*sensor_id = return_sensor_id();
			if ( (*sensor_id) == (imgsensor_info.sensor_id) ) {
				...
				if(ReadModuleId == 0x51){
					LOG_INF("qtech read_module_id sucess: %x\n", ReadModuleId);
					*sensor_id = S5KJNS_SENSOR_ID;
					return ERROR_NONE;
				}else{
...
kal_uint16 addr_data_pair_set_test_pattern_s5kjnsqtech[] = {
	0x0200,0x0002,
	0x0202,0x0002,
	0x0204,0x0020,
	0x020E,0x0100,
...
UINT32 S5KJNS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
