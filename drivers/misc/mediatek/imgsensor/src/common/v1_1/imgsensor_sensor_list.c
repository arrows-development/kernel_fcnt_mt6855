...
{S5KJNS_SENSOR_ID, SENSOR_DRVNAME_S5KJNS_MIPI_RAW, S5KJNS_MIPI_RAW_SensorInit},
#endif
#if defined(SC202A_MIPI_RAW)
{SC202A_SENSOR_ID, SENSOR_DRVNAME_SC202A_MIPI_RAW, SC202A_MIPI_RAW_SensorInit},
#endif
#if defined(S5K4H7_SUNNY_FRONT_MIPI_RAW)
{S5K4H7_SUNNY_FRONT_SENSOR_ID, SENSOR_DRVNAME_S5K4H7_SUNNY_FRONT_MIPI_RAW, S5K4H7_SUNNY_FRONT_MIPI_RAW_SensorInit},
#endif
#if defined(S5KJNS_SUNNY_MAIN_MIPI_RAW)
{S5KJNS_SUNNY_MAIN_SENSOR_ID, SENSOR_DRVNAME_S5KJNS_SUNNY_MAIN_MIPI_RAW, S5KJNS_SUNNY_MAIN_MIPI_RAW_SensorInit},
#endif
