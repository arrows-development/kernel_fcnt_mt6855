...
#endif
#if defined(S5KJNS_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KJNS_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1050, 1},
...
#endif
#if defined(SC202A_MIPI_RAW)
	{
		SENSOR_DRVNAME_SC202A_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
...
#endif
#if defined(S5K4H7_SUNNY_FRONT_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K4H7_SUNNY_FRONT_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
