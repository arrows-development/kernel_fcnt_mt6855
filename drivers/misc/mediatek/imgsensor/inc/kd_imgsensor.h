...
//add by hq for yamato camera start
#define S5K4H7_SENSOR_ID                        0x487B
#define SENSOR_DRVNAME_S5K4H7_MIPI_RAW          "s5k4h7_mipi_raw"
#define S5KJNS_SENSOR_ID                        0x38EF
#define SENSOR_DRVNAME_S5KJNS_MIPI_RAW          "s5kjns_mipi_raw"
#define SC202A_SENSOR_ID                        0xEB52
#define SENSOR_DRVNAME_SC202A_MIPI_RAW          "sc202a_mipi_raw"
#define S5K4H7_SUNNY_FRONT_SENSOR_ID            0x487A
#define SENSOR_DRVNAME_S5K4H7_SUNNY_FRONT_MIPI_RAW    "s5k4h7_sunny_front_mipi_raw"
#define S5KJNS_SUNNY_MAIN_SENSOR_ID             0x38EE
#define SENSOR_DRVNAME_S5KJNS_SUNNY_MAIN_MIPI_RAW     "s5kjns_sunny_main_mipi_raw"
//add by hq for yamato camera end
/******************************************************************************
 *
 ******************************************************************************/
