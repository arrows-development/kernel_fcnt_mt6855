...
extern unsigned int sc202cs_read_otp_info(struct i2c_client *client, unsigned int addr, unsigned char *data, unsigned int size);
extern unsigned int s5k4h7_read_otpdata(struct i2c_client *client, unsigned int addr, unsigned char *data, unsigned int size);
extern unsigned int s5k4h7_sunny_read_otpdata(struct i2c_client *client, unsigned int addr, unsigned char *data, unsigned int size);
...
struct stCAM_CAL_LIST_STRUCT g_camCalList[] = {
	...
	{S5KJNS_SENSOR_ID, 0xA0, Common_read_region, MAX_EEPROM_SIZE_16K},
	{S5KJNS_SUNNY_MAIN_SENSOR_ID, 0xA0, Common_read_region, MAX_EEPROM_SIZE_16K},
	{SC202A_SENSOR_ID, 0x6C, sc202cs_read_otp_info},
	{S5K4H7_SENSOR_ID, 0x5A, s5k4h7_read_otpdata},
	{S5K4H7_SUNNY_FRONT_SENSOR_ID, 0x5A, s5k4h7_sunny_read_otpdata},
