...
#define JD9365T_DD_PASSWORD_CODE1          (0x93)
#define JD9365T_DD_PASSWORD_CODE2          (0x83)
#define JD9365T_DD_PASSWORD_CODE3          (0x16)
#define JD9365T_DDREG_MODE                 (JD_DDREG_MODE_0)
...
enum JD9365T_HEADER_INFO {
    JD9365T_HW_HEADER_MAX_SIZE         = JD9365T_BIN_FW_HEADER_SIZE,
    JD9365T_HW_HEADER_CRC_NUMBER       = 2,
    JD9365T_HW_HEADER_INITIAL_NUMBER   = 3,
    JD9365T_HW_HEADER_MOVE_INFO_NUMBER = 12,
    JD9365T_HW_HEADER_PSRAM_START_ADDR = JD9365T_MEMORY_ADDR_PRAM,
};
...
enum JD9365T_FLASH_RUN_TIME {
    ...
    JD9365T_FLASH_RUN_TIME_ERASE_SECTOR_TIME    = 75,
    JD9365T_FLASH_RUN_TIME_ERASE_BLOCK_32K_TIME = 200,
    JD9365T_FLASH_RUN_TIME_ERASE_BLOCK_64K_TIME = 350,
    JD9365T_FLASH_RUN_TIME_ERASE_CHIP_TIME      = 2300,
};
...
enum JD9365T_TIMER_REG_ADDR {
    ...
    JD9365T_TIMER_REG_ADDR_WDT_CONFIG = (JD9365T_TIMER_BASE_ADDR << 8) + 0x32,
    JD9365T_TIMER_REG_ADDR_RTC_CONFIG = (JD9365T_TIMER_BASE_ADDR << 8) + 0x42,
};

enum JD9365T_TIMER_RELATED_SETTING {
    /* 0x32[0] */
    JD9365T_TIMER_RELATED_SETTING_WDT_STOP = 0x02,
    /* 0x42[0] */
...
enum JD9365T_DMA_RELATED_SETTING {
    ...
    /* 0x0D[1] */
    JD9365T_DMA_RELATED_SETTING_DMA_ABORT                 = 0x01,
    /* 0x0C[4] */
...
enum JD9365T_FLASH_REG_ADDR {
    ...
    JD9365T_FLASH_REG_ADDR_DMA_0ABORT                  = (JD9365T_FLASH_BASE_ADDR << 8) + 0x0D,
...
enum JD9365T_SOC_REG_ADDR {
    ...
    JD9365T_SOC_REG_ADDR_DBIC_PAGE_EN   = (JD9365T_SOC_BASE_ADDR << 8) + 0x7E,
    JD9365T_SOC_REG_ADDR_DBIC_PAGE      = (JD9365T_SOC_BASE_ADDR << 8) + 0x7F,
    JD9365T_SOC_REG_ADDR_POR_INIT       = (JD9365T_SOC_BASE_ADDR << 8) + 0x81,
};
...
enum JD9365T_SOC_PASSWORD {
    ...
    JD9365T_SOC_PASSWORD_POR_CLEAR       = 0x00,
};
