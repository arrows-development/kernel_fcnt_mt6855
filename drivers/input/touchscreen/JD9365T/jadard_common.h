...
#define JADARD_DRIVER_VER        "01.A5" /* MAJOR_VER.MINOR_VER */
...
#define JD_TOUCH_STYLUS_SIZE      (12)
...
extern int jdtp_parse_boot_mode(struct device *dev);
