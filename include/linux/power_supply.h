...
enum {
	...
	POWER_SUPPLY_HEALTH_CHG_OVERTIME,
	POWER_SUPPLY_HEALTH_USB_CONNECT_ERROR,
	POWER_SUPPLY_HEALTH_BATTERY_OVERVOLTAGE,
	POWER_SUPPLY_HEALTH_UNDERVOLTAGE,
	POWER_SUPPLY_HEALTH_DEVICE_HOT,
	POWER_SUPPLY_HEALTH_USB_OVERTEMPERATURE,
};
